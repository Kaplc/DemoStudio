...
/** 科研线清单（2026-09-08 环线移除：聚能环建设独立成 RingPanel/环详情面板） */
const LINES = ['engine', 'cargo', 'infra', 'expand'] as const
...
export default class ResearchPanelScript extends BehaviourScript {
  ...
  override onUpdate(dt: number): void {
    ...
    // 四线：进度 / 已分配点数 / 实时 H3 消耗速率（计费中琥珀色，未计费灰）
