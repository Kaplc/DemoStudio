...
## 5. 游戏设计（doc/game/，18 篇）

> 《暖流计划》的设计文档（主方案 + 平衡快照 + 3 份 V1 专项方案 + 13 篇模块设计）。**设计意图与实装现状的差异**：2026-09-10 已对「与代码相反」的描述做校正、对「设计未实现」处就地标注，读到时以标注为准；两份 2026-09-11 的专项方案已实施（状态行见各文档）。
...
| [`game/modules/12-全息地球建造.md`](./game/modules/12-全息地球建造.md) | 全息地球建造：底栏 4 按钮（⚡ 环节点 + 资源/地表建筑/轨道建筑）分类面板 + 球面落位（2026-09-18 改版实装口径） |
