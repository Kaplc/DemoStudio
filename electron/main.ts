    ...
    if (req.method === 'POST' && req.url === '/api/command') {
      ...
      req.on('end', () => {
        try {
          ...
          if (cmd.command === 'ai_event' || cmd.command === 'ai_list_events' || cmd.command === 'run_asset_lint' || cmd.command === 'run_code_lint' || cmd.command === 'ui_compile' || cmd.command === 'ui_decompile' || cmd.command === 'get_scene_outline' || cmd.command === 'get_ui_outline' || cmd.command === 'get_assets' || cmd.command === 'start_game' || cmd.command === 'stop_game') {
