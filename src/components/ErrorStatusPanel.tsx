 ...
 * - 展示 consoleErrors（logger ERROR/WARN 行，由 Console 组件过滤写入 editorStore）
 * - 行首按级别着色：ERROR 红 / WARN 黄，点击条目复制整行到剪贴板
 * - 顶部"清空"按钮只清报错记录（主控制台历史不受影响）；"复制全部"复制所有报错
 */
