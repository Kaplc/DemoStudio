...
export const CLASH_BUILDING_TYPES: ClashBuildingType[] = [
  ...
  { id: 'barracks', name: '兵营', color: 0xe53935, size: 1.3, height: 1.0, footprint: 2, blueprint: 'asset/blueprints/buildings/barracks.blueprint.json', hp: 400, lootCoins: 0, lootElixir: 0, blocksGround: true },
