...
export const DEFAULT_TROOPS: Record<string, TroopType> = {
  barbarian: {
    ...
    housing: 1, cost: 25, trainTime: 20, hp: 45, dps: 8, range: 0.5, speed: 4,
  ...
  archer: {
    ...
    housing: 1, cost: 50, trainTime: 25, hp: 20, dps: 7, range: 3.5, speed: 6,
  ...
  goblin: {
    ...
    housing: 1, cost: 25, trainTime: 22, hp: 25, dps: 11, range: 0.5, speed: 8,
  ...
  giant: {
    ...
    housing: 5, cost: 250, trainTime: 120, hp: 300, dps: 11, range: 0.8, speed: 3,
  ...
  wallBreaker: {
    ...
    housing: 2, cost: 1000, trainTime: 120, hp: 20, dps: 12, range: 0.5, speed: 6,
  ...
  balloon: {
    ...
    housing: 5, cost: 2000, trainTime: 240, hp: 150, dps: 25, range: 0.5, speed: 2.5,
  ...
  wizard: {
    ...
    housing: 4, cost: 1500, trainTime: 180, hp: 75, dps: 50, range: 3.5, speed: 4,
  ...
  healer: {
    ...
    housing: 14, cost: 5000, trainTime: 360, hp: 500, dps: 0, range: 4.0, speed: 4,
  ...
  dragon: {
    ...
    housing: 20, cost: 25000, trainTime: 900, hp: 1900, dps: 140, range: 2.0, speed: 4,
  ...
  pekka: {
    ...
    housing: 25, cost: 30000, trainTime: 900, hp: 2800, dps: 260, range: 0.8, speed: 4,
